...
contextBridge.exposeInMainWorld('weekcal', {
  ...
  authListUsers: () => ipcRenderer.invoke('weekcal-auth:list-users'),
  authAddUser: (email) => ipcRenderer.invoke('weekcal-auth:add-user', email),
  authRemoveUser: (email) => ipcRenderer.invoke('weekcal-auth:remove-user', email),
